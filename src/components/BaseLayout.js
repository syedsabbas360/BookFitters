...
export default class BaseLayout extends Component {
  ...
  <div className="w3-container">
    ...
    <nav className="w3-bar w3-black">
      <NavLink to ='/' className="w3-bar-item w3-button" activeStyle={{color: "white"}}> <Link to='/'></Link><img hef='http://icons.iconarchive.com/icons/martz90/circle/64/books-icon.png'/> </NavLink>
