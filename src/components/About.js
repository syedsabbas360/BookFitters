 ...
 export default class About extends Component {
   render() {
     return (
         ...
         <div className="About">
           <h1>About Us</h1>
           <p>Welcome to Coding BookFitters, your #1 source to learn coding! We're dedicated to giving you the very best of coding resources, with a focus on skill levels ranging from beginners, intermediate to advanced.</p>
